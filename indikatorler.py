...
KATALOG = {
    ...
    "StochRSI_K_1W": {"ad": "Stokastik RSI %K (haftalık)", "alan": "Stoch.RSI.K|1W", "grup": "Osilatör", "tur": "osilator", "aralik": (0,100), "op": "<", "deger": 20, "zaman_yok": True},
    "StochRSI_D_1W": {"ad": "Stokastik RSI %D (haftalık)", "alan": "Stoch.RSI.D|1W", "grup": "Osilatör", "tur": "osilator", "aralik": (0,100), "op": "<", "deger": 20, "zaman_yok": True},
    ...
    "Perf.3M": {"ad": "3 aylık getiri %", "alan": "Perf.3M", "grup": "Fiyat/Hacim", "tur": "osilator", "aralik": (-60, 100), "op": ">", "deger": 0},
...
ACIKLAMALAR = {
    ...
    "StochRSI_K_1W": "Stokastik RSI %K, haftalık grafikte.",
    "StochRSI_D_1W": "Stokastik RSI %D, haftalık grafikte.",
